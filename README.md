...
5. Click `Done`.
6. Open [`Privacy & Security`](x-apple.systempreferences:com.apple.settings.PrivacySecurity.extension) in System Settings, scroll to the message `“OpenMacHelper.app” was blocked to protect your Mac.` and click `Open Anyway`.
